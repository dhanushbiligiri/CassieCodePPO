...
class LSTM_Actor(Actor):
    ...
    def init_hidden_state(self, batch_size=1):
        ...
        # self.hidden = [torch.zeros(batch_size, l.hidden_size).to(self.device) for l in self.actor_layers]
        # self.cells = [torch.zeros(batch_size, l.hidden_size).to(self.device) for l in self.actor_layers]
